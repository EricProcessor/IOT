...
function loadCollection() {
    ...
    var compress = function (res, orientation) {
        ...
        img.onload = function () {
            ...
            $.ajax({
                type:"POST",
                url: "/annualMeeting/upload.action",
                dataType:"json",
                data: {
                    erp: $("#pin").val(),
                    img:dataUrl
...
function getPic() {
    ...
    //跳采集
    window.location.href = "/signin/reCollect.html?pin="+$("#pin").val()+"&nickName="+$("#nickName").val();
}